...
function Footer() {
    return (
        <footer className="bg-black mt-5">
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-10 sm:px-6 lg:px-8 lg:pt-16">
                <div className="text-center">
                    <h2 className="text-6xl font-extrabold text-white font-cursive">
                        Feel The  <span className='text-primary'>Taste  !</span> 
                    </h2>
                ...
                <div className="mt-16 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-12 dark:border-gray-800">
