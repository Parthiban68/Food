        ...
        <div className="grid lg:grid-cols-2 gap-1 md:grid-cols-1 ">
          ...
          <div className=' flex justify-center flex-wrap p-5 gap-5'>
            <div className='w-[300px] bg-white rounded-3xl h-[560px] p-2 border-l-8 border-secondary'>
              ...
              <div className='px-5'>
                ...
                <div className='flex justify-between'>
                  ...
                  <p className='text-[20px] font-semibold hover:cursor-pointer'>-</p>
                ...
                <div className='pX-2 flex justify-between'>
                  ...
                  <button className='bg-orange-500 p-3 rounded-3xl font-semibold hover:text-white'>Add to <i class="fa-regular fa-heart"></i></button>
                </div>
              </div>
            </div>
            <div className='w-[300px] bg-white rounded-3xl h-[560px] p-2 border-l-8 border-secondary'>
              <img src={card1} alt="" className='h-[300px] w-[300px] p-2 items-center rounded-3xl' />
              <div className='px-5'>
                <h1 className='text-[40px] font-cursive font-bold text-primary'>Burger</h1>
                <div className='flex justify-between'>
                  <h3 className='text-[20px] font-semibold'> Price : <span className='text-[30px]'>$22</span></h3>
                  <p className='text-[20px] font-semibold hover:cursor-pointer'>-</p>
                  <p className='text-[20px] font-semibold'>{count}</p>
                  <p className='text-[20px] font-semibold hover:cursor-pointer'>+</p>
                </div>
            ...
            <div className='w-[300px] bg-white rounded-3xl h-[560px] p-2 border-l-8 border-secondary'>
              <img src={card1} alt="" className='h-[300px] w-[300px] p-2 items-center rounded-3xl' />
              <div className='px-5'>
                <h1 className='text-[40px] font-cursive font-bold text-primary'>Cake</h1>
                <div className='flex justify-between'>
                  <h3 className='text-[20px] font-semibold'> Price : <span className='text-[30px]'>$29</span></h3>
                  <p className='text-[20px] font-semibold hover:cursor-pointer'>-</p>
                  <p className='text-[20px] font-semibold'>{count}</p>
                  <p className='text-[20px] font-semibold hover:cursor-pointer'>+</p>
                </div>
            ...
            <div className='w-[300px] bg-white rounded-3xl h-[560px] p-2 border-l-8 border-secondary'>
              <img src={card1} alt="" className='h-[300px] w-[300px] p-2 items-center rounded-3xl' />
              <div className='px-5'>
                <h1 className='text-[40px] font-cursive font-bold text-primary'>Noodles</h1>
                <div className='flex justify-between'>
                  <h3 className='text-[20px] font-semibold'> Price : <span className='text-[30px]'>$40</span></h3>
                  <p className='text-[20px] font-semibold hover:cursor-pointer'>-</p>
                  <p className='text-[20px] font-semibold'>{count}</p>
                  <p className='text-[20px] font-semibold hover:cursor-pointer'>+</p>
                </div>
