...
import { about4 } from '../../assets/image'
...
const About = () => {
  return (
    <div className=' bg-black flex flex-col lg:flex-row justify-center items-center gap:10 lg:py-24 py-20 px-10 lg:px-20 w-full h-fit'>
